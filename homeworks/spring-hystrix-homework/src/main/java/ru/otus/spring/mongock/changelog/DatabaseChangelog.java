...
public class DatabaseChangelog {
    ...
    @ChangeSet(order = "003", id = "insertUsers", author = "galeevki")
    public void insertUsers(UserRepository repository) {
        //Пароль passw0rd
        repository.save(new User("USER", "$2a$12$4JRoWnNV64pNQmcrU.yL3OfUzn.HIVDe2rBMF3/MsjuBE0vSxAiKS", "ROLE_USER"));
        repository.save(new User("ADMIN", "$2a$12$4JRoWnNV64pNQmcrU.yL3OfUzn.HIVDe2rBMF3/MsjuBE0vSxAiKS", "ROLE_ADMIN"));
    }
